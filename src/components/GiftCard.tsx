...
import { ExternalLink, Check, Package, Trash2, Pencil } from 'lucide-react';
...
export const GiftCard = ({ gift, onToggleAvailability, onDelete, onEdit }: GiftCardProps) => {
            ...
            <div className="flex gap-2">
              ...
              {onEdit && (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-sage-300 text-sage-700 hover:bg-sage-50 hover:border-sage-400"
                >
